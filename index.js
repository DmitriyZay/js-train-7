...
let myObject = {
  ...
  //Створюємо змінну value якій присвоємо властивість 
  //name елемента масиву category з індексом currentIndex
  ...
  next() {
    ...
    return this.currentIndex < this.category.length
      ? { done: false, value: this.category[this.currentIndex++].name  }
      : { done: true };
  },
